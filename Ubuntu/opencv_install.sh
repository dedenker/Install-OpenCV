...
cmake   -D BUILD_DOCS=OFF -D OPENCV_EXTRA_MODULES_PATH=/home/ec2-user/opencv_contrib/modules -D CMAKE_BUILD_TYPE=RELEASE -D BUILD_opencv_aruco=OFF -D BUILD_opencv_optflow=OFF -D BUILD_TESTS=OFF -D BUILD_PERF_TESTS=OFF  -D BUILD_EXAMPLES=OFF -D INSTALL_PYTHON_EXAMPLES=OFF -D CMAKE_INSTALL_PREFIX=/usr/local ..
make -j 4
sudo make install
